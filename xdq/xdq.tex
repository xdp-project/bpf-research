...
\begin{itemize}
  \item Explain that the Qdisc layer currently supports two types of BPF programs. These programs are a BPF based classifier and filters.
  \item Explain why these BPF programs
\end{itemize}
...
\begin{itemize}
  \item Explain the building blocks of Cong Wang's BPF-Qdisc.
  \item Explain what changes are needed to make it better.
  \item Explain the limitations of the BPF-Qdisc.
\end{itemize}
